...
public class PagoCredito extends PanacheEntity{
	...
	@OneToMany(mappedBy = "pagoCredito")

    /**
    Instances of classes  for PagoCredito
    */
    ...
    /**
    Methodos Getter and Setter for  PagoCredito class
    */
